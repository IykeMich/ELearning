...
import { IoIosAlert, IoMdFlashOff, IoMdHappy } from "react-icons/io";
...
const SlideLeft = (delay) => {
    return {
        ...
        animate: {
            opacity: 1, x: 0, transition: {duration: 0.3, delay:delay, ease: "easeInOut"}
        },
    }
}
        ...
        <div className="container pb-14 pt-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8">
                {ServicesData.map((service) => (
                    ...
                    animate="animate"
                    viewport={{ once: true }}
                    key={service.id} className="bg-[#f4f4f4] rounded-2xl flex
                    flex-col gap-4 items-center justify-center p-4 py-7 hover:scale-110
